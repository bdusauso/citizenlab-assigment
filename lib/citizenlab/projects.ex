defmodule Citizenlab.Projects do
  @moduledoc """
  ...
  alias Citizenlab.Projects.{Folder, Project}
  ...
  def list_projects do
    query =
      from Project,
        ...
        preload: [:topics, :folder]

    Repo.all(query)
  end

  def list_projects(parent_id) do
    inner_query =
      from f0 in Folder,
        join: f1 in assoc(f0, :parent),
        where: f1.id == ^parent_id,
        select: f1.id
